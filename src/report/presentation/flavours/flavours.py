...
def get_html_renderable_mapping() -> Dict[Type[Renderable], Type[Renderable]]:
    ...
    """
    from data_profiling.src.report.presentation.flavours.html import (
        HTMLSequence,
        HTMLVariable,
        HTMLVariableInfo,
        HTMLTable,
...
def get_widget_renderable_mapping() -> Dict[Type[Renderable], Type[Renderable]]:
    from data_profiling.src.report.presentation.flavours.widget import (
        WidgetSequence,
        WidgetVariable,
        WidgetVariableInfo,
        WidgetTable,
...
def get_qt_renderable_mapping() -> Dict[Type[Renderable], Type[Renderable]]:
    from data_profiling.src.report.presentation.flavours.qt import (
        QtSequence,
        QtVariable,
        QtVariableInfo,
        QtTable,

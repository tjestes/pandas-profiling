...
import sys
from data_profiling.src.report.formatters import get_fmt_mapping

# Initializing Jinja
package_loader = PackageLoader(
    "pandas_profiling", str(sys.path[0]) + "/pandas_profiling/src/pandas_profiling/report/presentation/flavours/html/templates"
)

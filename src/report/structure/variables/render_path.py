...
from data_profiling.src.report.presentation.core import Image, FrequencyTable
from data_profiling.src.report.structure.variables.render_categorical import (
    render_categorical,
)

...
from data_profiling.src.model.base import (
    Boolean,
    Real,
    Count,
    Complex,
...
from data_profiling.src.report.structure.correlations import get_correlation_items
from data_profiling.src.report.structure.overview import (
    get_dataset_overview,
    get_dataset_warnings
)
from data_profiling.src.report.structure.variables import (
    render_boolean,
    render_categorical,
    render_complex,
    render_date,
...
from data_profiling.src.visualisation.plot import make_pie_chart
...
def get_report_structure(
    ...
    # # TODO: Pie charts...disabling section for now until high cardinality function added
    # section_items.append(
    #     Sequence(
    #         get_pie_chart(summary['pie']),
    #         sequence_type="tabs",
    #         name="Pie Charts",
    #         anchor_id="pie-chart",
    #     )

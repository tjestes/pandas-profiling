...
from data_profiling.src.model.messages import MessageType
from data_profiling.src.version import __version__
from data_profiling.src.utils.dataframe import rename_index
from data_profiling.src.utils.paths import get_config_default, get_config_minimal
from data_profiling.src.config import config
from data_profiling.src.controller import pandas_decorator
from data_profiling.src.model.describe import describe as describe_df
from data_profiling.src.model.messages import MessageType
from data_profiling.src.report import get_report_structure
...
class ProfileReport(object):
    ...
    def to_notebook_iframe(self):
        ...
        """
        from data_profiling.src.report.presentation.flavours.widget.notebook import (
            get_notebook_iframe,
        )
    ...
    def to_widgets(self):
        ...
        from data_profiling.src.report.presentation.flavours import WidgetReport
    ...
    def to_app(self):
        ...
        """
        from data_profiling.src.report.presentation.flavours.qt.app import get_app
        from data_profiling.src.report.presentation.flavours import QtReport
